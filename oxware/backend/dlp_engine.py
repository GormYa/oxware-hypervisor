"""
OXware DLP at Hypervisor — pattern-based outbound traffic inspection
─────────────────────────────────────────────────────────────────────
...
Persistent rules: /var/lib/oxware/dlp_rules.json
Match events:     /var/log/oxware/dlp_events.jsonl
"""
...
_RULES_FILE  = Path("/var/lib/oxware/dlp_rules.json")
_EVENTS_FILE = Path("/var/log/oxware/dlp_events.jsonl")
