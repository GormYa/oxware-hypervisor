"""
OXware Syslog Manager — Centralized log viewer.
...
log = logging.getLogger("oxware.syslog")
...
def get_oxware_logs(lines=200):
    """Read OXware application logs from journald."""
    return get_journal_logs(lines=lines, service="oxware")
