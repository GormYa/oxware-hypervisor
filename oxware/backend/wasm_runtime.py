"""
wasm_runtime.py — WebAssembly Runtime Manager for OXware
...
Config persisted to /var/lib/oxware/wasm_modules.json
...
_DATA_FILE = Path("/var/lib/oxware/wasm_modules.json")
