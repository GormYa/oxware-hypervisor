...
Persistent state: /var/lib/oxware/backup_321.json
"""
...
_DATA_FILE = Path("/var/lib/oxware/backup_321.json")
...
def _offsite_s3(src: str, config: dict) -> dict:
    ...
    try:
        ...
        bucket     = config.get("bucket", "oxware-backups")
