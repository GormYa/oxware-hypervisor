"""
edge_mode.py — Edge Deployment Manager for OXware
...
Config persisted to /var/lib/oxware/edge_config.json
...
_CONFIG_FILE = Path("/var/lib/oxware/edge_config.json")
...
def send_heartbeat() -> dict:
    ...
    try:
        req = urllib.request.Request(
            url,
            data=payload,
            headers={"Content-Type": "application/json", "X-OXware-Node": node_id},
            method="POST",
        )
