"""
OXware Cross-Site Replication — v2.5.7
────────────────────────────────────────
...
Persistent state: /var/lib/oxware/cross_replication.json
"""
...
_DATA_FILE = Path("/var/lib/oxware/cross_replication.json")
