...
log = logging.getLogger("oxware.anomaly")

ANOMALIES_FILE = "/var/lib/oxware/anomalies.json"
BASELINE_FILE  = "/var/lib/oxware/baselines.json"
CONFIG_FILE    = "/var/lib/oxware/anomaly_config.json"
