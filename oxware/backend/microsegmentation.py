...
Features:
  ...
  - Config persisted to /var/lib/oxware/microseg_policies.json (reboot restore)
...
_POLICY_FILE = Path("/var/lib/oxware/microseg_policies.json")
