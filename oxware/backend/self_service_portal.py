"""
OXware Self-Service Portal — End-User Limited VM Operations
─────────────────────────────────────────────────────────────
...
sınırlı eylemler yapabilmesi için arayüz.
  ...
  - Audit log: /var/lib/oxware/self_service_requests.jsonl
...
_AUDIT_FILE = Path("/var/lib/oxware/self_service_requests.jsonl")
