"""
OXware Cloud Export — Workload Mobility (AWS / Azure / GCP)
────────────────────────────────────────────────────────────
...
outside OXware's scope). This module handles qemu-img conversion and
...
_EXPORTS_FILE = Path("/var/lib/oxware/cloud_exports.json")
_EXPORT_DIR   = Path("/var/lib/oxware/cloud_export_staging")
