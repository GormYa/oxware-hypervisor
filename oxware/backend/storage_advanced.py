"""
OXware Storage Advanced — Dedup, Tiering, SPBM, iSCSI
─────────────────────────────────────────────────────
...
_TIER_POLICY = Path("/var/lib/oxware/storage_tiers.json")
_SPBM_POLICY = Path("/var/lib/oxware/spbm_policies.json")
