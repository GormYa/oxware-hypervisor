"""
OXware Backup Verification — v2.5.7
─────────────────────────────────────
...
Log: /var/log/oxware/backup_verify.jsonl
"""
...
_LOG_FILE = Path("/var/log/oxware/backup_verify.jsonl")
...
def _verify_mount(backup_path: str, verify_id: str) -> dict:
    ...
    dev = "/dev/nbd0"
    mount_pt = f"/tmp/oxware_verify_{verify_id}"
...
def _verify_boot(backup_path: str, verify_id: str) -> dict:
    ...
    vm_name = f"oxware-verify-{verify_id}"
