"""
OXware Service Catalog — Self-Service VM Templates
─────────────────────────────────────────────────────
Operatörün kataloğa eklediği "ready-to-deploy" VM şablonları.

  - Persistent: /var/lib/oxware/service_catalog.json (atomic write)
...
_FILE = Path("/var/lib/oxware/service_catalog.json")
