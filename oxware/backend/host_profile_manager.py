"""
OXware Host Profile Manager
Captures and applies host configurations as reusable profiles.
Storage: /var/lib/oxware/host_profiles.json
"""
import json, uuid, subprocess, logging, threading
from datetime import datetime, timezone
from pathlib import Path

log = logging.getLogger("oxware.host_profile")
_PROFILES_FILE = Path("/var/lib/oxware/host_profiles.json")
