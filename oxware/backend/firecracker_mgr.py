"""
firecracker_mgr.py — Firecracker microVM Manager for OXware
OXware v2.5.11 Modern Workloads
...
Config persisted to /var/lib/oxware/firecracker_vms.json
...
_DATA_FILE = Path("/var/lib/oxware/firecracker_vms.json")
_SOCKET_DIR = Path("/var/lib/oxware/firecracker_sockets")
...
def create_microvm(
    ...
    vcpus: int = 1,
    mem_mb: int = 512,
    kernel_path: str = "/opt/oxware/vmlinux",
    rootfs_path: str = "/opt/oxware/rootfs.ext4",
) -> dict:
    """
