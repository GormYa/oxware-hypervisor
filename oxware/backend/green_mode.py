"""
OXware Green Mode - AI-driven Power Optimization
================================================
...
State: /var/lib/oxware/green_mode.json
Audit: /var/log/oxware/green_mode.jsonl
"""
...
STATE_PATH = Path("/var/lib/oxware/green_mode.json")
AUDIT_PATH = Path("/var/log/oxware/green_mode.jsonl")
PERF_DB_PATH = Path("/var/lib/oxware/perf_history.db")
...
def _safe_import(name: str):
    try:
        ...
        try:
            return importlib.import_module(f"oxware.backend.{name}")
        except Exception:
            return None
