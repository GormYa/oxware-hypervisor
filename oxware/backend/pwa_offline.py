"""OXware PWA offline support (v3.0).
...
served from `/sw.js` (already exists in `oxware/frontend/static/sw.js`).
"""
...
log = logging.getLogger("oxware.pwa")
_CONFIG_PATH = Path("/var/lib/oxware/pwa_offline.json")

DEFAULT_CACHE = [
    "/",
    "/static/manifest.json",
    "/static/img/oxware-icon.png",
...
def sw_manifest() -> dict:
    ...
    cfg = _load_config()
    return {
        "version": cfg.get("cache_version", "oxware-v0"),
