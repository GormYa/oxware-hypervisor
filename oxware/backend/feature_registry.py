...
FEATURE_MANIFEST = [
    ...
    {"id": "otel",           "name": "Distributed Tracing",    "category": "observability","module": "otel_tracing",        "status": "beta",   "version": "2.5.8"},
    {"id": "grafana_embed",  "name": "Grafana Embed",          "category": "observability","module": "grafana_embed",       "status": "beta",   "version": "2.5.8"},
    {"id": "topology_viz",   "name": "Topology Visualization", "category": "observability","module": "topology_viz",        "status": "beta",   "version": "2.5.8"},
    {"id": "heatmap",        "name": "Heatmaps + Forecast",    "category": "observability","module": "ml_forecaster",       "status": "beta",   "version": "2.5.8"},
    {"id": "config_drift",   "name": "Config Drift Detection", "category": "lifecycle",    "module": "drift_capacity",      "status": "beta",   "version": "2.5.8"},
    {"id": "capacity_plan",  "name": "Capacity Planning",      "category": "observability","module": "drift_capacity",      "status": "beta",   "version": "2.5.8"},
    {"id": "microseg",       "name": "Microsegmentation (L7 nftables)", "category": "network", "module": "microsegmentation", "status": "beta", "version": "2.5.9"},
    {"id": "bfd",            "name": "BFD (Bidirectional Forwarding)",  "category": "network", "module": "bfd_manager",       "status": "beta", "version": "2.5.9"},
    {"id": "service_chain",  "name": "Service Chaining (IDS/WAF/LB)",  "category": "network", "module": "service_chain",     "status": "beta", "version": "2.5.9"},
    {"id": "service_mesh",   "name": "Service Mesh (Istio/Linkerd)",   "category": "network", "module": "service_mesh",      "status": "beta", "version": "2.5.9"},
    ...
    {"id": "pulumi",         "name": "Pulumi Provider",        "category": "automation",   "module": "pulumi_provider",     "status": "beta",   "version": "2.5.10"},
