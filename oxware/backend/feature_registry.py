...
FEATURE_MANIFEST = [
    ...
    {"id": "service_catalog","name": "Service Catalog",        "category": "multi-tenancy","module": "service_catalog",     "status": "planned","version": "2.5.6"},
    {"id": "api_rate_limit", "name": "API Rate Limit per Tenant","category": "multi-tenancy","module": "tenant_rate_limit", "status": "planned","version": "2.5.6"},
    {"id": "app_consistent", "name": "App-Consistent Snapshots","category": "storage",     "module": "app_consistent_snap", "status": "planned","version": "2.5.7"},
    {"id": "backup_321",     "name": "3-2-1 Backup",           "category": "storage",      "module": "backup_321",          "status": "planned","version": "2.5.7"},
    {"id": "backup_verify",  "name": "Backup Verification",    "category": "storage",      "module": "backup_verifier",     "status": "planned","version": "2.5.7"},
    {"id": "cross_replicate","name": "Cross-Site Replication", "category": "dr",           "module": "cross_replicator",    "status": "planned","version": "2.5.7"},
