"""
OXware Chargeback Engine — Per-Tenant Cost Tracking
─────────────────────────────────────────────────────
İcra anlık (on-demand) — periodic job YOK; sunucuya yük yapmaz.

  - Fiyatlandırma: /var/lib/oxware/chargeback_config.json
  - Faturalar:    /var/lib/oxware/invoices/<tenant>/<YYYY-MM>.json
...
_CFG_FILE     = Path("/var/lib/oxware/chargeback_config.json")
_INVOICE_DIR  = Path("/var/lib/oxware/invoices")
