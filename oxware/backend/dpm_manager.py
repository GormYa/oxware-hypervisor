"""
OXware DPM — Distributed Power Management
Monitors cluster node utilization and recommends/executes power actions.
Storage: /var/lib/oxware/dpm_config.json
"""
import json, logging, threading, subprocess, time
from datetime import datetime, timezone
from pathlib import Path

log = logging.getLogger("oxware.dpm")
_CONFIG_FILE = Path("/var/lib/oxware/dpm_config.json")
