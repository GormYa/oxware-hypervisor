"""
OXware Automation Engine — Auto-remediation + Policy-as-Code + Workflows
────────────────────────────────────────────────────────────────────────
...
_RULES    = Path("/var/lib/oxware/automation_rules.json")
_POLICIES = Path("/var/lib/oxware/policies.json")
_HISTORY  = Path("/var/lib/oxware/automation_history.json")
