"""
OXware Site Recovery Manager (SRM-lite) + RPO/RTO Monitoring
────────────────────────────────────────────────────────────
...
_PLANS  = Path("/var/lib/oxware/dr_plans.json")
_RUNS   = Path("/var/lib/oxware/dr_runs.json")
_RPO    = Path("/var/lib/oxware/rpo_targets.json")
