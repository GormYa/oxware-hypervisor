"""
OXware Workflow Engine — Drag-drop multi-step automation
──────────────────────────────────────────────────────────
...
_DATA_FILE    = Path("/var/lib/oxware/workflows.json")
_HISTORY_FILE = Path("/var/lib/oxware/workflow_history.json")
