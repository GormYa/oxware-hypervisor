#!/usr/bin/python
# -*- coding: utf-8 -*-
"""Manage OXware VMs (create/delete/start/stop/snapshot)."""
...
---
module: vm
short_description: Manage OXware VMs
description:
  - Create, delete, start, stop, reboot, snapshot OXware VMs via REST API.
options:
  name:
...
RETURN = r"""
vm:
  description: VM details from OXware API.
  returned: always
  type: dict
changed:
