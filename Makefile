...
.PHONY: sbom
sbom:
	$(PYTHON) -c "from oxware.backend import sbom_generator; \
import json; print(json.dumps(sbom_generator.generate(), indent=2))"

.PHONY: security
security:
	bandit -r oxware/backend -ll -i || true
