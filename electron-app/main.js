...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      ...
      // Allow self-signed TLS — OXware uses a self-signed cert by default
      webSecurity:      false,
    },
    icon:  getAppIcon(),
    show:  false,
...
function setupAutoUpdater() {
  ...
  autoUpdater.on('update-available', (info) => {
    ...
    dialog.showMessageBox(mainWindow || undefined, {
      ...
      message: `OXware Desktop ${info.version} is ready to download.`,
  ...
  autoUpdater.on('update-downloaded', () => {
    dialog.showMessageBox(mainWindow || undefined, {
      ...
      message: 'OXware Desktop will restart to apply the update.',
